# CS571 F25 HW10 API Documentation
...
`GET` `https://cs571api.cs.wisc.edu/rest/f25/hw10/chatrooms`
...
`GET` `https://cs571api.cs.wisc.edu/rest/f25/hw10/messages?chatroom=CHATROOM_NAME&num=NUM`
